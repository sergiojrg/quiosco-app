  ...
  return (
    ...
    >
        ...
        <div>
            <button
                type="button"
                className=" text-center bg-sky-700 flex justify-center gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full lg:w-auto"
            ...
            <button
                type="button"
                className="mt-5 text-center  bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full lg:w-auto"
